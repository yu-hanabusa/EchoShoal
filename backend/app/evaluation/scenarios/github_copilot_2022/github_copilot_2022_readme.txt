...
月額$10/個人の価格設定で、開発者の生産性を飛躍的に向上させるツールとして
...
・三次ターゲット：企業の開発チーム（セキュリティ要件を満たすBusiness版で対応予定）
・特に生産性向上へのプレッシャーが強い、スタートアップやテック企業の開発者

■ チーム・資金調達
・開発元：GitHub（2018年にMicrosoft が$7.5Bで買収）
・AI技術提供：OpenAI（Microsoftが2019年に$1B出資）
...
■ ロードマップ（2022年6月時点の公開情報）
・Copilot for Business：企業向け機能の強化（開発中）
